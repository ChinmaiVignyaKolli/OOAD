                    ...
                    int parent[])
{
    ...
    { count++;
        int v = *i;  // v is curent adjacent of 'u'
        ...
        if (disc[v] == -1)
        {
                ...
                (disc[u] > 1 && low[v] >= disc[u]) )
            {
                ...
                st->pop_back();
                cout << endl;
                //cout<< "Articulation pt is  "<<v<<endl;
                count++;
            }
        }
 	 ...
 	 cout<<u<<"vertex has degree :  "<<count<<endl;
}
...
int main()
{
    ...
    g.addEdge(14,15);
    //g.addEdge(10,11);
    //g.addEdge(1,0);//g.addEdge(1,0);
   /* g.addEdge(3,0);//g.addEdge(2,1);
    g.addEdge(3,2);//g.addEdge(3,1);
    //g.addEdge(2,1);//g.addEdge(3,2);
    g.addEdge(4,5);//g.addEdge(4,2);
